...
// QUANDO HOUVER REQUISIÇÃO AO SERVIDOR SUANDO API/V1/POSTAGEM, A REQUISIÇÃO PASSARÁ A CONSUMIR ESSA CLASSE
...
public class PostagemControlador {
	...
	// VARIAVEL NOVOUSUARIO E SERA USADO DENTRO DO METODO
